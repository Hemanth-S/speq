...
between phases. Stop only when:
  ...
  c) /project:verify produces a ❌ FAIL

In any of those cases: stop, report the exact blocker clearly, and wait.

━━━ PHASE 1 — ENRICH ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Execute all steps from /project:enrich.

Exit condition: PRD.md contains completed sections for Codebase
...
Execute all steps from /project:spec.

Do not pause to ask the user to confirm capabilities — infer them
from the PRD and proceed. The user can run /project:spec manually
...
Execute all steps from /project:plan.
...
Execute all steps from /project:implement.
...
Execute all steps from /project:verify.
...
/project:verify. Do not proceed to Phase 6 with any open failures.

━━━ PHASE 6 — DONE ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Execute all steps from /project:done.
